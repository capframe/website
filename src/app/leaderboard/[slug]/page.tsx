...
import { NextStep } from "./_next-step";
      ...
      <main className="px-6 sm:px-10 lg:px-16">
        <section className="max-w-[920px] mx-auto pt-12 sm:pt-16 pb-24">
          ...
          {/* Next step. This page previously had no outbound path except
              ...
              refuse to make. Lives in a client component so the clicks are
              measurable — an unmeasured funnel is a guess with a CTA on it. */}
          <NextStep
            slug={slug}
            score={row.score}
